...
public class LivingRoom extends Rooms {
    ...
    LivingRoom() {
        ...
        description = ("This room is by far the largest in the house with a chic, yet comfy modern decor. Two large windows with " +
                        ...
                        "flat screen with no visible cables over ");
    }
}
